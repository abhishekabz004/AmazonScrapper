...
class TshirtsspiderSpider(scrapy.Spider):
    ...
    def parse(self, response):
    	...
    	for product in response.css('li.s-result-item'):
    		...
    		image_url = product.css('div.a-spacing-base div.a-span12 span.a-declarative div.a-gesture-horizontal div.s-active a.a-link-normal img.s-access-image::attr(src)').extract_first()#.encode('utf-8')
    		...
    		yield {
    			...
    			'imageUrl': product.css('div.a-spacing-base div.a-span12 span.a-declarative div.a-gesture-horizontal div.s-active a.a-link-normal img.s-access-image::attr(src)').extract_first(),                
